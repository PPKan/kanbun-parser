...
\renewcommand{\jlreqkanjiskip}{2.30315pt plus 0.1pt minus 0.1pt}
...
\long\def\@makefntext#1{%
  \begingroup
  \ltjsetparameter{kanjiskip=0pt plus .25\zw minus 0pt}%
  \parindent 1em%
  \noindent
  \hb@xt@3em{\hss\@makefnmark\hspace{0.8em}}#1%
  \par
  \endgroup
}
\renewcommand{\footnoterule}{%
  \kern -3pt
  \hrule width 0.68\columnwidth
  \kern 2.6pt
}
\makeatother
